...
import { Search, CheckCircle, XCircle, LogOut, Eye } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-medium">
                  {selectedTamu.tanggal_kunjungan} {selectedTamu.waktu_masuk}
                </p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Waktu Keluar</p>
                <p className="font-medium">
                  {selectedTamu.waktu_keluar ? `${selectedTamu.tanggal_kunjungan} ${selectedTamu.waktu_keluar}` : '-'}
                </p>
              </div>
